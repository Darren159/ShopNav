    ...
    <>
      ...
      <SafeAreaView style={styles.safeAreaView}>
        ...
        <View style = {{ flexDirection: 'row', justifyContent: 'flex-end' , padding: 10}}>
          <TouchableOpacity onPress={handleSignOut} style= {{ flexDirection: 'column', justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderRadius: 10, backgroundColor: 'white'}}>
            <Image
              style = {{ height: 40, width: 40 }}
              source = {{ uri: "https://th.bing.com/th/id/OIP.kEapEfmfmXwTkw5mILXfHQHaHa?w=202&h=202&c=7&r=0&o=5&pid=1.7"}}
            />
            <Text> Sign Out </Text>
          </TouchableOpacity>
        </View>
